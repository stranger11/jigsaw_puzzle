...
class PuzzleActivity : AppCompatActivity() {
    ...
    private fun setFlowerPic(imageView: ImageView) {
        ...
        try {
            ...
            val bitmap =
                BitmapFactory.decodeResource(this@PuzzleActivity.resources, R.drawable.flowers)
    ...
    private fun splitImage(): List<PuzzlePiece> {
        ...
        val cols = 3
        val imageView = findViewById<ImageView>(R.id.imageView)
        val pieces: MutableList<PuzzlePiece> = mutableListOf()
